      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-4">
        {activeTab === "properties" ? (
          ...
          <div className="space-y-4">
            <div className="text-[11px] font-bold text-neutral-400 uppercase tracking-wider">
              A6 Physical Page & Card Setup
            </div>

            {/* A6 Orientation */}
            <div>
              <label className="text-[10px] text-neutral-400 block mb-1">Page Orientation</label>
              <div className="grid grid-cols-2 gap-2">
                <button
                  type="button"
                  onClick={() =>
                    setProject((prev) => ({
                      ...
                      cardWidthMm: 74,
                      cardHeightMm: 105,
                      frontPosMm: { x: (105 - 74) / 2, y: 5 },
                      backPosMm: { x: (105 - 74) / 2, y: 5 + 105 + 6 },
                    }))
                  }
